...
export const categories: Category[] = [
  ...
  },
  {
    ...
    image: toophan.url,
    models: [
      m({ modelNo: "CSI-ST-SILVER-1200", name: "Super Toophan Silver 1200mm", price: 3299, sweep: "1200 mm (48 inch)", rpm: "360–400 RPM", airDelivery: "220–235 CMM", warranty: "3 Years", power: "70–80 W", voltage: "220–240 V AC", frequency: "50 Hz", blades: "3 Aerodynamic", bladeMaterial: "Aluminium (Silver/White-Silver)", motor: "100% Copper Winding · Double Ball Bearing", colors: ["Silver", "White-Silver"], image: superToophanSilver.url, images: [superToophanSilver.url, csiCeilingPremium, csiCeilingBronze], highlights: ["Best performance in low voltage", "Decorative integrated light", "100% copper · double ball bearing"], features: ["Best performance in low voltage", "Decorative integrated light fitting", "100% copper winding motor", "Double ball bearing for long life", "1200 mm (48\") aerodynamic 3-blade sweep", "ISO 9001:2015 certified manufacturing", "Downrod ceiling mount"], description: "The Super Toophan Silver is engineered for the best performance in low voltage conditions. A 3-blade 1200mm ceiling fan with decorative integrated light fitting, 100% copper winding motor, double ball bearing and a class-leading 3-year warranty.", tags: ["New Arrival", "Best Seller"] }),
