...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Contact CSI Fans — head office in Nalanda, Bihar." },
  ...
  return (
    <div className="py-16 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        <SectionHeader eyebrow="Contact" title="Let's Talk" subtitle="We're here to help — send us a message." />

        <div className="mt-12 grid lg:grid-cols-2 gap-8">
          <div className="space-y-4">
            <div className="flex items-start gap-4 rounded-2xl bg-white/70 backdrop-blur-xl ring-1 ring-white/60 p-5 shadow-sm hover:shadow-md transition-shadow">
              <div className="h-11 w-11 grid place-items-center rounded-xl bg-gradient-to-br from-[#0d4361] to-[#0d6b78] text-white"><MapPin className="h-5 w-5" /></div>
              <div>
                <p className="font-[Inter] text-xs text-[#0d6b78] font-semibold uppercase tracking-wide">Address</p>
                <p className="font-[Poppins] text-[#0a2f44] font-semibold">CSI Fans, Nalanda, Bihar 803101, India</p>
              </div>
            </div>
